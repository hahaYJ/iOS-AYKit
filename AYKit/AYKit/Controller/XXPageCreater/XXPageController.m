...
- (void)viewDidLayoutSubviews {
    if(_currentIndex > 0) {
        [self.collectionPage scrollToItemAtIndexPath:[NSIndexPath indexPathForItem:_currentIndex inSection:0] atScrollPosition:UICollectionViewScrollPositionLeft animated:YES];
        [self.collectionMain scrollToItemAtIndexPath:[NSIndexPath indexPathForItem:_currentIndex inSection:0] atScrollPosition:UICollectionViewScrollPositionLeft animated:YES];
        [UIView animateWithDuration:0.25 animations:^{
            _line.frame = CGRectMake(_currentIndex *_lineWidth, _pageBarHeight - 3, _lineWidth, 3);
        }];
    }
}
